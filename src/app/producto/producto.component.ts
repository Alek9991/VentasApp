...
// ngOnInit() {
//   this.productosFiltrados = this.dataSource; // al iniciar, muestra todos
// }

// aplicarFiltro() {
//   const valorFiltro = this.filtro.toLowerCase();
//   this.productosFiltrados = this.dataSource.filter(p =>
//     p.nombre.toLowerCase().includes(valorFiltro)
//   );
// }
...
//           searching: true,
//           ordering: true,
//           dom: 'Bfrtip', // Aquí se agregan los botones
//           buttons: [
//             'copyHtml5',
//             'excelHtml5',
//             'pdfHtml5',
